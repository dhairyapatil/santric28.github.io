<%@ Page Language="VB" MasterPageFile="~/mpAdminMng.master" AutoEventWireup="false" CodeFile="frmChangeP.aspx.vb" Inherits="frmChangeP" %>
            ...
            <td class="style14">
                ...
                <table cellpadding="2" cellspacing="2" class="style1">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPCat" runat="server" Height="32px" Width="220px" DataSourceID="SqlDataSource2" 
                                                        DataTextField="C_Name" DataValueField="C_Name">
                                <asp:ListItem>Select</asp:ListItem>
                            </asp:DropDownList>
                                ...
                                <tr>
                                    <td align="center">
                                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" 
                                                        ...
                                                        NavigateUrl="~/frmChangeP.aspx">Update Another Product</asp:HyperLink>
                                                </td>
                                </tr>
                                <tr>
                                    <td align="center">
