<%@ WebHandler Language="VB" Class="ghImg_PMaster" %>
...
Public Class ghImg_PMaster : Implements IHttpHandler
    ...
    Public Function funRetriveImg(ByVal img_name As String) As Byte()
        cn.Open()
        Dim cmd As New SqlCommand("SELECT P_Img FROM tblPMaster WHERE (P_Name = @nm)", cn)
