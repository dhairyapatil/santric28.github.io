<%@ Page Language="VB" MasterPageFile="~/mpAdminMng.master" AutoEventWireup="false" CodeFile="frmAdminPChange.aspx.vb" Inherits="frmAdminPChange" %>
                ...
                <table cellpadding="2" cellspacing="2" class="style1">
                    ...
                    <tr>
                        <td class="style13" align="right">
                                ...
                                Font-Names="Arial" Text="Select Product To Change" Font-Bold="False" 
                                ForeColor="#000066"></asp:Label>
                                                </td>
                        <td>
                            <asp:DropDownList ID="ddlOldPCName" runat="server" Height="32px" Width="220px" 
                                BackColor="#FBFBFF">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                ControlToValidate="ddlOldPCName" ErrorMessage="Select Product To Change" 
                                ...
                                <tr>
                                    <td align="center">
                                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" 
                                                        ...
                                                        NavigateUrl="~/frmAdminPChange.aspx">Change Another Product</asp:HyperLink>
                                                </td>
                                </tr>
                                <tr>
                                    <td align="center">
